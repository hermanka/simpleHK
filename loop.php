...
?>
	  ...
	  <div class="row">
		<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12" style="padding-left:0!important">
		...
		<div class="col-lg-4 col-md-5 col-sm-5 col-xs-12 blog-title" style="padding-left:0!important">
			...
			<?php else : ?>
			<p class="blog-post-meta"><span class="glyphicon glyphicon-calendar"></span> <?php the_time( $date_format ) ?></p>
			<?php endif; ?>
		</div>
		</div>
